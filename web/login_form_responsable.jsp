...
<html>
    ...
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
        ...
        <form action="LoginController_responsable" method="post">
            <center>
              ...
              <div class="form-group">
                         <input type="password" required="required" class="form-control input-lg" placeholder="Your Password" name="pwd" value="<jsp:getProperty name="Responsable" property="pwd"/>">
              </div>   
                            <center><a class="btn btn-primary btn-block btn-lg" href="register_form_responsable.jsp">Register</a></center>
